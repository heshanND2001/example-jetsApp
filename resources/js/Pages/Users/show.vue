    ...
    <AppLayout title="Show Users">
        ...
        <AuthenticationCard>
            <div class="text-center mb-4 mt-0">
                ...
                <h1 class="title font-semibold text-2xl">Show User</h1>
            </div>
            ...
            <div class="mb-4">
                ...
                <p>
                    ...
                    <span
                        ...
                        :key="role.id"
                        class="mr-1 bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded"
                    >
                        {{ role.name
